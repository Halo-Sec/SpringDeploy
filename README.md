...
--
---
The application was deployed to an AWS Elasticbeanstalk environment using Jenkins as the CI/CD pipeline. 
The terraform files for deploying the Jenkins controller and slave node are also present. Kindly make the necessary adjustments as indicated.
